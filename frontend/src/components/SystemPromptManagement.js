  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="flex flex-col gap-4 p-6 max-w-screen-xl mx-auto w-full">
        <div className={`bg-white dark:bg-gray-800 rounded-xl shadow-lg transition-all duration-300 ${isFormCollapsed ? 'h-16 overflow-hidden' : ''}`}>
          ...
          <form onSubmit={handleSubmit} className="p-4 pt-0">
            ...
            <div className="flex gap-4">
              <button type="submit" className="flex-1 py-2 px-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg hover:opacity-90 transition-opacity font-medium">
