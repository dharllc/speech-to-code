...
const CostDisplay = ({ totalCost, totalTokens }) => (
  <div className="mb-6 bg-gray-800 p-4 rounded-lg shadow-lg">
    <div className="flex justify-between items-center mb-4">
      <h3 className="text-xl font-bold text-white">Usage Summary</h3>
    </div>
    <div className="flex flex-wrap -mx-2">
      <div className="w-full sm:w-1/2 px-2 mb-4">
        <div className="bg-gray-700 p-3 rounded-lg flex items-center">
          <FaDollarSign className="text-green-400 mr-2 text-xl" />
          <div>
      ...
      <div className="w-full sm:w-1/2 px-2 mb-4">
        <div className="bg-gray-700 p-3 rounded-lg flex items-center">
          ...
          <div>
            <span className="text-sm font-semibold text-gray-300">Total Tokens</span>
